     ...
     <div class="cuntainer">
        <div class="wolf">
            ...
            <div class="footer-ol">
                <h4>online shop</h4>
                <ul>
                    <li><a href="trimer.php?cat_id=7">Salon Products</a></li><br><br>
            ...
            <p class="credit">Copyright &copy; <span>2015-2021</span> | all rights reserved. | <span>Designed By Abens</span></p>
        </div>
     </div>
  </footer>
